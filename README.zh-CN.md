...
| 283 | [Move Zeroes](https://leetcode.com/problems/move-zeroes/) | 简单 | [✓](./283_moveZeroes_1.py) | [✓₁](./283_moveZeroes_1.java) · [✓₂](./283_moveZeroes_2.java) | 1) 计数 + 左移 + 末尾补 0（两次遍历）；2) 快慢双指针，遇到非零就交换（一次遍历） |
